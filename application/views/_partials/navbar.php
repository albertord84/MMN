        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
                <?php foreach ($menu as $parent => $parent_params): ?>
                    ...
                    <?php if ($this->ion_auth->logged_in() && ($parent == 'login' || $parent == 'signup')): ?>
                    <?php elseif (empty($page_auth[$parent_params['url']]) || $this->ion_auth->in_group($page_auth[$parent_params['url']])): ?>
